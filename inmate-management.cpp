...
{   
    ...
    ifstream inFile;
    ofstream temp;
    temp.open("temp.txt"); // temp file for the
    ...
    if(inFile.is_open())
    {
        ...
        cout<<" Enter lastName to delete Record ";
        cin>> last;
        cout<<"enter firstName to delete record";
        cin>>first;
    }
